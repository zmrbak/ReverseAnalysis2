...
$LL4@f_add:
; Line 10
	vmovdqu	xmm0, XMMWORD PTR [esi+ecx*4]
	vpaddd	xmm0, xmm0, XMMWORD PTR [eax-16]
	mov	edx, DWORD PTR tv1015[esp+32]
	lea	eax, DWORD PTR [eax+64]
	vmovdqu	XMMWORD PTR [ebp-32], xmm0
	vmovdqu	xmm0, XMMWORD PTR [ebx+eax-64]
	vpaddd	xmm0, xmm0, XMMWORD PTR [eax-64]
	vmovdqu	XMMWORD PTR [edi+eax-64], xmm0
	vmovdqu	xmm0, XMMWORD PTR [edx+ebp]
	vpaddd	xmm0, xmm0, XMMWORD PTR [eax-48]
	mov	edx, DWORD PTR _sz$[esp+28]
	lea	ebp, DWORD PTR [ebp+64]
	vmovdqu	XMMWORD PTR [ebp-64], xmm0
	vmovdqu	xmm0, XMMWORD PTR [esi+ecx*4+48]
	vpaddd	xmm0, xmm0, XMMWORD PTR [eax-32]
	add	ecx, 16					; 00000010H
	vmovdqu	XMMWORD PTR [ebp-48], xmm0
