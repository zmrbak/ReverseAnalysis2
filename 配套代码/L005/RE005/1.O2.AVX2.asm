...
$LL4@f_add:
; Line 10
	vmovdqu	ymm0, YMMWORD PTR [ebx+ecx*4]
	vpaddd	ymm0, ymm0, YMMWORD PTR [eax-32]
	mov	edx, DWORD PTR tv1019[esp+32]
	lea	eax, DWORD PTR [eax+128]
	vmovdqu	YMMWORD PTR [ebp-64], ymm0
	vmovdqu	ymm0, YMMWORD PTR [edi+eax-128]
	vpaddd	ymm0, ymm0, YMMWORD PTR [eax-128]
	vmovdqu	YMMWORD PTR [esi+eax-128], ymm0
	vmovdqu	ymm0, YMMWORD PTR [edx+ebp]
	vpaddd	ymm0, ymm0, YMMWORD PTR [eax-96]
	mov	edx, DWORD PTR _sz$[esp+28]
	lea	ebp, DWORD PTR [ebp+128]
	vmovdqu	YMMWORD PTR [ebp-128], ymm0
	vmovdqu	ymm0, YMMWORD PTR [ebx+ecx*4+96]
	vpaddd	ymm0, ymm0, YMMWORD PTR [eax-64]
	add	ecx, 32					; 00000020H
	vmovdqu	YMMWORD PTR [ebp-96], ymm0
